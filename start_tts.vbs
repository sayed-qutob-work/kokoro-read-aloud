...
'        via UI Automation; windowless python). The caption-strip overlay.py
'        was retired from autostart 2026-07-17 (user: no bottom transcript);
'        add a line like this one back if it is ever wanted again. ---
sh.Run "C:\kokoro\env\Scripts\pythonw.exe C:\kokoro\highlighter.py", 0, False
